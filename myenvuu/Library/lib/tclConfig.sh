...
# installed.
TCL_PREFIX='U:/Projects/myproject3/myproject/myproject/myenvuu\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='U:/Projects/myproject3/myproject/myproject/myenvuu\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='U:/Projects/myproject3/myproject/myproject/myenvuu\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IU:/Projects/myproject3/myproject/myproject/myenvuu\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LU:/Projects/myproject3/myproject/myproject/myenvuu\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='U:/Projects/myproject3/myproject/myproject/myenvuu\Library\lib\tclstub86.lib'
